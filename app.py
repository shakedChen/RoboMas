...
DOC_TYPES = {
    ...
    "form_867": {
        ...
        "label": "טופס 867 — אישור ניכוי מס במקור (רווח הון)",
        "desc": "אישור ניכוי מס במקור על רווח הון מניירות ערך סחירים בבורסה ומכשירים פיננסיים. מתקבל מהבנק / ברוקר הישראלי.",
        "multiple": True, "accept": ".pdf,.jpg,.jpeg,.png",
        "icon": "📊",
    },
    "form_867_annex": {
...
INCOME_DOC_MAP = {
    ...
    "real_estate_fund":   ["form_867", "bank_account"],
